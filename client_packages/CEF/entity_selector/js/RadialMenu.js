...
RadialMenu.prototype.createMenu = function (classValue, levelItems, nested) {
    ...
    if (nested) {
        self.createCenter(svg, 'Close', '#return', 8); ce_selecteaza = true;
    } else {
        self.createCenter(svg, 'Close', '#close', 7); ce_selecteaza =  null;
    }
    ...
    svg.addEventListener('click', function (event) {
        ...
        switch (className) {
            ...
            {   
                ...
                if(ce_selecteaza == null && (index == 0 || index == 1))
                { 
                    mp.trigger("accessing_menu_event");    
                }
                else 
                {
                    self.handleClick(); 
...
//self.handleClick(); este functia pentru a arata itemele
RadialMenu.prototype.show_final = function () {
